...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/api/**") // 특정 API 경로에 대해서만 허용
                .allowedMethods("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS")
                .allowedHeaders("X-AUTH-TOKEN", "Content-Type") // 실제 사용하는 헤더만 포함
                .maxAge(CORS_MAX_AGE_SECS)
                .allowedOrigins("http://localhost:5173", "http://127.0.0.1:5173","https://super-coding-shoes-project-team1.duckdns.org") // localhost와 127.0.0.1 모두 허용
